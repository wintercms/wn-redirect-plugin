...
return [
    ...
    'redirect' => [
        ...
        'from_scheme_comment' => 'Принудительное совпадение протоколов. Если выбранное HTTP путь: <u>https://domain.com/path</u> '
            . 'не совпадет с <u>https://domain.com/path</u>.',
        'to_url' => 'Путь редиректа или URL',
        'to_url_placeholder' => '/absolute/path, relative/path или https://target.url',
        ...
        'sparkline_30d' => 'Перенаправления (30дн)',
        'has_hits' => 'Переходы',
        'minimum_hits' => 'Минимум # переходов',
        ...
        'ignore_case_comment' => 'Движок редиректов будет работать без учёта регистра.',
        'ignore_trailing_slash' => 'Игнорировать завершающий слэш',
        'ignore_trailing_slash_comment' => 'Движок редиректов будет игнорировать завершающий слэш.',
        'forward_query_parameters' => 'Пересылать параметры запроса',
        'forward_query_parameters_comment' => 'Механизм перенаправления будет пересылать параметры запроса.',
        'last_used_at' => 'Последнее перенаправление',
        'updated_at' => 'Обновлено',
        'invalid_regex' => 'Неправильное регулярное выражение.',
        'created_due_to_bad_request' => 'Создано из-за неправильного запроса.',
    ],
    'list' => [
    ...
    'statistics' => [
        'hits_per_day' => 'Кол-во перенаправлений по дням',
        'click_on_chart' => 'Нажмите на график, чтобы включить масштабирование и перетаскивание.',
        'requests_redirected' => 'Перенаправлено запросов',
        'all_time' => 'за всё время',
        'active_redirects' => 'Активных редиректов',
        'redirects_this_month' => 'Перенаправлено в этом месяце',
        'previous_month' => 'Прошлый месяц',
        'latest_redirected_requests' => 'Последний перенаправленный запрос',
        'redirects_per_month' => 'Перенаправлений в месяц',
        'no_data' => 'Нет данных',
        'top_crawlers_this_month' => 'Топ :top сканботов за этот месяц',
        'top_redirects_this_month' => 'Топ :top редиректов за этот месяц',
        'activity_last_three_months' => 'Активность последние 3 месяца',
        'crawler_hits' => 'Переходов сканботами',
        'visitor_hits' => 'Всего переходов',
    ],
    'title' => [
        'import' => 'Импорт',
        'export' => 'Экспорт',
    ...
    'import_export' => [
        ...
        'hits' => 'Перенаправлений редиректа [hits]',
